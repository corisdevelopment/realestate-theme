...
import 'kleur/colors';
import { A as AstroError, R as ResponseSentError, F as ForbiddenRewrite } from './chunks/astro/server_DVJ5F72b.mjs';
import 'clsx';
...
const onRequest$1 = defineMiddleware(async ({ locals, request }, next) => {
  if (request.method === "POST") {
    ...
    const isStoryblokRequest = url.searchParams.has("_storyblok") && url.searchParams.has("_storyblok_c");
